...
for ext in ["*.png", "*.jpeg", "*.jpg"]:
  images = glob.glob(os.path.join("/home/longhn/Annotation_2906/train", ext))
  all_files += images
...
with open("/home/longhn/Annotation_2906/train.txt", "w", encoding="utf8") as writefile:
    i = 0
    for file in glob.glob("/home/longhn/Annotation_2906/train/*.txt"):
...
i = 0
for file in glob.glob("/home/longhn/Annotation_2906/test/*.txt"):
    with open(file, "r", encoding="utf8") as readfile:
        label = readfile.read()
    file = '/'.join(file.split('/')[-3:])
    print(file)
