...
start = time.time()
test = open("/home/longhn/Annotation_2906/test.txt", "w", encoding="utf8")
train = open("/home/longhn/Annotation_2906/train.txt", "w", encoding="utf8")
valid = open("/home/longhn/Annotation_2906/valid.txt", "w", encoding="utf8")

all_files = []
for ext in ["*.png", "*.jpeg", "*.jpg"]:
    images = glob.glob(os.path.join("/home/longhn/Annotation_2906/data", ext))
    all_files += images
...
url_train = '/home/longhn/Annotation_2906/train/'
url_test = '/home/longhn/Annotation_2906/test/'
...
if os.path.exists(url_test) is False:
    os.system(dir_test)
i = 0
for file in glob.glob("/home/longhn/Annotation_2906/data/*.txt"):
